...
function ProductCarousel({products}) {
        ...
        let sortedProducts= products.sort((a, b) => b.discountPercentage - a.discountPercentage)
    ...
    <Carousel> 
        {
          ...
          src={product.images[0]}
                ...
                <div className='d-sm-flex justify-content-center'>
                  <p className='me-2'>$</p>  
                <p className='text-decoration-line-through text-white-50 '>{product.price}</p> 
                  <p className='ms-2'>{(product.price - ((product.discountPercentage/100) * product.price)).toFixed(2)}</p> 
